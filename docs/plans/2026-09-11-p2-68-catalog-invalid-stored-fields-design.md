...
> 状态：**已实现并合并 —— PR #471（merge `83ad1779`，2026-09-11）**；v1 于 2026-09-11 批准（「都按你的推荐来」），§4 的 GUI 草稿部分随 Codex R1–R4 收窄为三态 provenance（用户拍板方案 A）。roadmap 条目：`docs/roadmap-first-call.md` `### P2-68`。
