...
| **P1-53** | 多暗室校准数据隔离，禁止跨暗室误用校准结果 | 🟡 开发中 |
...
| 桶 | 内容 |
|----|------|
| **LOCAL-OPEN (roadmap 内)** | **~~P2-25~~ ✅ → ~~P1-49~~ ✅ → ~~P1-50~~ ✅ → ~~P1-51~~ ✅ → ~~P1-52~~ ✅ → P1-53 🟡 → P2-26 → P2-27 → P2-28 → P2-29 → P2-30 → P2-31 → P2-32 → P2-33 → P2-34 → P3-20 → P3-21**；当前 P1-53 开发中、WIP=1；P1-52 已由 PR #345 完成并按两轮外审规则收口。完整编号、范围与状态只看顶部 Current Focus 表。 |
