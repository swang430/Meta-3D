...
**Current Focus = P1-73「CMW500 单载波 LTE 2×2 MIMO OTA」已立项，架构方案 #1 与六章完整设计已获用户批准，当前进入实施计划。2026-08-24 批准队列六片已全部完成：~~P2-41~~ ✅ #386 → ~~P1-68~~ ✅ #388 → ~~P1-69~~ ✅（设计稿获批）→ ~~P1-70~~ ✅ #392 → ~~P1-71~~ ✅ #394 → ~~P1-72~~ ✅ #396；P2-32 与维护池 P3-20/P3-21 按既定规矩不得自动启动。**
...
> 文件名推断。
>
> **现场确认口径**：当前正式能力准入只要求实机型号、固件与 KS520/相关 LTE 选件，adapter
