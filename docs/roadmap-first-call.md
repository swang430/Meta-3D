...
| **P1-61** | 正式 MIMO 报告必须使用最终执行状态、真实耗时与四态判决 | 🔄 六次 fresh 内审累计 11 P1 + 2 P2 均已按 TDD 修复；第六轮修正 commissioning 交接失败回落 pending、既有告警漏报新安全事实及 acquire/release 误分类，受影响链 200 passed，待第七次独立复审与最终全量回归 |
