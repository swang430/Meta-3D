...
**Current Focus = P1-52（P1-51 随 PR #344 合入后自动开始，WIP=1）**。P1-51 已完成设计、TDD、内审、两轮 Codex 外审与 R2 P1 尾部修复；
...
| **P1-52** | TestCase 编辑时 LabProfile 列表加载失败不得清空原绑定 | 🔄 Current Focus |
...
| 桶 | 内容 |
|----|------|
| **LOCAL-OPEN (roadmap 内)** | **~~P2-25~~ ✅ → ~~P1-49~~ ✅ → ~~P1-50~~ ✅ → ~~P1-51~~ ✅ → P1-52 🔄 → P1-53 → P2-26 → P2-27 → P2-28 → P2-29 → P2-30 → P2-31 → P2-32 → P2-33 → P2-34 → P3-20 → P3-21**；当前 P1-52 WIP=1，P1-51 已按两轮外审规则收口。完整编号、范围与状态只看顶部 Current Focus 表。 |
