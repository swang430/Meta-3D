...
Current Focus（非现场）= P2-54（RAT-neutral MAC profile，PR #437 外审中；P2-64～P2-67 已由 PR #433/#434/#435/#436 全部合并）。**
...
**~~P1-74~~（✅ 非现场半 #429，现场半待真机） → ~~P1-75~~（✅ #431） → ~~P2-64~~（✅ #433） → ~~P2-65~~（✅ #434） → ~~P2-66~~（✅ #435） → ~~P2-67~~（✅ #436） → **P2-54（进行中，#437）** → P2-55 → P2-56 →
...
在真实型号与手册确定前保持 HOLD，位于队列末尾且不阻断任何已批准片。P2-64～P2-67 已由 PR #433/#434/#435/#436 全部合并，四片整组收口完毕；当前 WIP=1 落在 P2-54（#437 外审中）。
...
2. **非现场队列（本地开发 / 手册取证 / 自动化验证）**：先消化已经取得的现场证据；
   **P2-9 的精确 `ERROR 3` 分类与 NEW-1 的活动 F64 输出集合本地半均已完成**；
   ...
   Mock 能力、Readiness、证据终态与日志导出四片整组收口完毕；**当前非现场 WIP = P2-54**
   （RAT-neutral MAC profile，#437 外审中），随后 P2-55～P2-56 续收 CMW500 MAC 真值，
...
| 桶 | 内容 |
|----|------|
| **LOCAL-OPEN (roadmap 内)** | **当前非现场 WIP=1：P2-54（RAT-neutral MAC profile，PR #437 外审中）**；NEW-1/P2-42～P2-53 已分别由 PR #407/#408/#409/#410/#411/#412/#413/#414/#415/#417/#420/#422/#424 合并，后续现场热修/分型号配置保存由 PR #425/#426/#427 合并。已批准的雷达顺序为 ~~P1-74~~（✅ 非现场半 #429）→ ~~P1-75~~（✅ #431）→ **~~P2-64~~（✅ #433）→ ~~P2-65~~（✅ #434）→ ~~P2-66~~（✅ #435）→ ~~P2-67~~（✅ #436）** → **P2-54（进行中，#437）** → P2-55～P2-62 → P2-63（HOLD，队列末尾）。该本地顺序不关闭、不降级 ON-SITE-BLOCKED 中原有 First-call Todo。P2-32 位于功能启用池，P3-20/P3-21 位于非阻塞维护池，均不得自动启动。现场静区线性 XY 扫描平台仍保持 Hardware Blocked。 |
...
### P2-54 — RAT-neutral MAC Test Profile（进行中：PR #437 外审中）
