...
**Current Focus = P1-59「CA 多小区正式吞吐量必须使用聚合真值」（R1 P1 已修，待最终 R2；2026-08-21）**。
...
> CA UNKNOWN/阻断。验证：相关回归 **279 passed**；全后端 **4166 passed / 5 skipped**；
...
| **P1-59** | CA 多小区正式吞吐使用聚合真值；PCell-only 不得冒充 CA 总吞吐 | 🟡 R1 P1 已修，待最终 R2；逐 SCell 激活态回读现场证据仍 Hardware Blocked |
