...
| D9 `input_level_calibration` 空回读仍记 `success: true` | → **P2-76**（本地完成，待外审） | 拆分下发与验证；空/部分预读只记 pending，复用同次 Cell-ready 功率观察后才可成功，缺真值 fail-closed |
