...
- **P1-38** 活动告警面板：清 674 条测试污染 + 接上真生产者 or 收窄让位
...
| 桶 | 内容 |
|----|------|
| **LOCAL-OPEN (roadmap 内)** | **~~P1-25~~ ✅ → ~~P1-26~~ ✅ → ~~P1-30~~ ✅ → ~~P1-31~~ ✅ → ~~P1-32~~ ✅ → ~~P1-33（本地半）~~ ✅ → ~~P1-34~~ ✅ → ~~P1-35~~ ✅ → P1-36 → P1-37 → P1-38 → P1-27 → P1-28 → P1-29 → P2-22 → P2-23 → P2-24 → P3-18 → P3-19**（2026-08-02 拍板二批队列 + 08-03 用户指定 P1-30 / P1-31 / P1-32 插队 + 08-05 用户指定 P1-34 插队；**队首现为 P1-36**，P1-25 / P1-26 / P1-30 / P1-31 / P1-32 / P1-33 本地半 已收口；一批 10 片已全收 #256–#265）|
