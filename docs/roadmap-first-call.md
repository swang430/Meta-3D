...
| 桶 | 内容 |
|----|------|
| **LOCAL-OPEN (roadmap 内)** | **当前非现场 WIP=P2-44（本地实现完成，正在生产路径门与完整回归）**；P2-42/P2-43 已分别由 PR #408/#409 合并，P2-44 合并后才开始 P2-45。前三项共同构成第三种 BS Emulator 的接入前置。该本地顺序不关闭、不降级 ON-SITE-BLOCKED 中原有 First-call Todo。P2-32 位于功能启用池，P3-20/P3-21 位于非阻塞维护池，均不得自动启动。现场静区线性 XY 扫描平台仍保持 Hardware Blocked。 |
