...
**Current Focus = P1-49（实现完成，等待内审/外审，WIP=1）**。P2-25 已由 PR #340（merge `ece3965`）
...
| ID | 正式条目 | 当前状态 |
|---|---|---|
| **P1-49** | 修复 `/calibration/channel/temporal/latest`、`/topologies/default` 静态路由遮挡 | 🔄 实现完成，待审 |
...
| 桶 | 内容 |
|----|------|
| **LOCAL-OPEN (roadmap 内)** | **~~P2-25~~ ✅ → P1-49 🔄 → P1-50 → P1-51 → P1-52 → P1-53 → P2-26 → P2-27 → P2-28 → P2-29 → P2-30 → P2-31 → P2-32 → P2-33 → P2-34 → P3-20 → P3-21**；当前 P1-49 WIP=1、实现完成待审。完整编号、范围与状态只看顶部 Current Focus 表。 |
