...
**Current Focus = P1-73C「CMW500 单载波 LTE 2×2 MIMO OTA 集成」；六章设计、P1-73A 与 P1-73B 已分别由 PR #399/#400/#401 合并，P1-73C Task 12–17 已完成本地实现、完整验证与 fresh 内审，下一步仅收口独立 Ready PR 的 Codex 外审。不得自动开始其他 feature。2026-08-24 批准队列六片已全部完成：~~P2-41~~ ✅ #386 → ~~P1-68~~ ✅ #388 → ~~P1-69~~ ✅（设计稿获批）→ ~~P1-70~~ ✅ #392 → ~~P1-71~~ ✅ #394 → ~~P1-72~~ ✅ #396；P2-32 与维护池 P3-20/P3-21 按既定规矩不得自动启动。**

> **P1-73 — CMW500 单载波 LTE 2×2 MIMO OTA（设计与 P1-73A/B 已合并；P1-73C 待外审）**
>
...
| 桶 | 内容 |
|----|------|
| **LOCAL-OPEN (roadmap 内)** | **P1-73 设计与 P1-73A/B 已由 PR #399/#400/#401 合并；当前 WIP 仅为 P1-73C 独立 PR 外审收口。** adapter 可注册、正式能力默认关闭；现场待确认项以 Warning 表示，不阻止开发。P2-32 位于功能启用池，P3-20/P3-21 位于非阻塞维护池，均不得自动启动。现场静区线性 XY 扫描平台及物理单位/方向/偏置/型号实证仍保持 Hardware Blocked。 |
