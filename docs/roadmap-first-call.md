...
| **P1-57** | 全局 LabProfile / 当前暗室上下文统一；拓扑、探头与首测不得各自选暗室 | 🔄 设计/计划已落盘，等待 Claude 实施 |
...
| 桶 | 内容 |
|----|------|
| **LOCAL-OPEN (roadmap 内)** | **~~P2-25~~ ✅ → ~~P1-49~~ ✅ → ~~P1-50~~ ✅ → ~~P1-51~~ ✅ → ~~P1-52~~ ✅ → ~~P1-53~~ ✅ → ~~P2-26~~ ✅ → ~~P1-54~~ ✅ → ~~P1-55~~ ✅ → ~~P1-56~~ ✅ → ~~P2-27~~ ✅ → ~~P2-28~~ ✅ → **P1-57 🔄** → P2-29 → P2-30 → P2-31 → P2-32 → P2-33 → P2-34 → P3-20 → P3-21**；P1-57 已由 2026-08-19 人工测试确认并提升为 Current Focus，设计/计划已落盘，等待 Claude 从独立 worktree 实施。当前 WIP=1，不启动 P2-29。现场物理单位/方向/偏置/型号实证仍保持 Hardware Blocked。完整编号、范围与状态只看顶部 Current Focus 表。 |
