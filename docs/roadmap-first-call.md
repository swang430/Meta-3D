...
**Current Focus = P1-54（设计完成，TDD RED 准备中，WIP=1）**。P2-26 已由 PR #347
...
生成假的低吞吐 KPI。设计见 [`P1-54 设计`](plans/2026-08-16-p1-54-kpi-valid-data-contract-design.md)。
...
| **P1-54** | `kpi_valid` 进入正式数据契约；缺测吞吐不得以默认 0.0 进入 MEASURE/KPI | 🟡 设计完成 / TDD RED 准备中 |
