...
**Current Focus = P1-59「CA 多小区正式吞吐量必须使用聚合真值」（R2 P1 已修，待 R3 P1-only 复审；2026-08-21）**。
...
> 一律保持 UNKNOWN。验证：相关回归 **296 passed**；全后端 **4168 passed / 5 skipped**；
...
| **P1-59** | CA 多小区正式吞吐使用聚合真值；PCell-only 不得冒充 CA 总吞吐 | 🟡 R2 P1 已修，待 R3 P1-only 复审；逐 SCell 激活态回读现场证据仍 Hardware Blocked |
...
| 桶 | 内容 |
|----|------|
| **LOCAL-OPEN (roadmap 内)** | 已完成历史见顶部表；当前顺序 **P1-59 ⏭ → P2-39 → P2-40 → P2-37 → P2-38 → P2-36 → P2-31 → P3-22**，当前 WIP=1（P1-59 待 R2）。P2-32 已转功能启用池，P3-20/P3-21 已转非阻塞维护池。现场物理单位/方向/偏置/型号实证仍保持 Hardware Blocked。完整编号、范围与状态只看顶部 Current Focus 表。 |
