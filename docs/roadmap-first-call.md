...
UTC，仅人读名称使用运行环境本地时区。相关链与规则门 **159 passed / 2 skipped**，全后端
**4240 passed / 5 skipped**，GUI production build、`compileall`、单一 Alembic head 与
`diff-check` 通过；fresh 内审 P1/P2/P3=0。设计与证据见
...
| **P1-60** | 最近一次手工执行的校准、信道与时间真值对齐 | 🔄 Ready PR；TDD/全量回归/fresh 内审完成，P1/P2/P3=0 |
