...
**Current Focus = P2-40「开发环境 DB / 日志沉积治理」（PR #364 Ready，Codex R1；2026-08-22）**。
...
| **P2-40** | 开发环境 DB / 日志沉积盘点、备份与可恢复清理 | 🟡 PR #364 Ready；Codex R1，实际清理另候批准 |
...
| 桶 | 内容 |
|----|------|
| **LOCAL-OPEN (roadmap 内)** | 已完成历史见顶部表；当前顺序 **P2-40 ⏭ → P2-37 → P2-38 → P2-36 → P2-31 → P3-22**，当前 WIP=1（P2-40 PR #364 外审中，实际清理另候批准）。P2-32 已转功能启用池，P3-20/P3-21 已转非阻塞维护池。现场物理单位/方向/偏置/型号实证仍保持 Hardware Blocked。完整编号、范围与状态只看顶部 Current Focus 表。 |
