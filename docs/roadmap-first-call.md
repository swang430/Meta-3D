...
| 2026-08-07 | [#297](https://github.com/swang430/Meta-3D/pull/297) | 🕒 R2 待审 | R1 修复 HEAD 尚待 R2：错误查询机制不可用时不得把当前业务组误记为 `rejected` | P1-41；R1 在 `3e594cc` 上出 1 条 P2，指出“归属未知”被误报为“业务命令被拒”。已补契约门并把不可用判定移到记录 rejection 之前；本行与 #296 漏行也随 R1 修复进入 R2 | **1** | 🕒 等 R2 |
