...
**Current Focus = P3-18 / p08 零残留站点参数化子片** —— PDF 转义与 G11 三覆盖面已分别由 PR #326/#327 合并；本片用同一条 fake 未认领错误逐站注入，锁住 p08 成功执行路径 10 个零残留归档/失败站点（含共同收尾；中止专用站点已有独立失败场景门）。诊断序列串行化 / 手写类型审计递归比对继续保持 P3-18 后续逐片 WIP=1。条目见下方 P3-18。
...
本地序列现切到 **P3-18 / p08 零残留站点参数化子片**（P1-29 已由 PR #320、P1-38 已由 PR #321、P1-27 已由 PR #322、P2-22 已由 PR #323、P2-23 已由 PR #324、P2-24 已由 PR #325、P3-18 PDF/G11 子片已由 PR #326/#327 收口）。本轮日志设计与逐片实施计划见
