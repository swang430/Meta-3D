...
**Current Focus = P2-40「开发环境 DB / 日志沉积治理」（只读盘点与设计完成，进入 TDD；2026-08-21）**。
...
> `meta3d_postgres_data` 约 79.65 MB，必须备份保护；另有 14 个未挂载匿名 Docker
...
| **P2-39** | pytest 与运行日志目录隔离，测试不得轮转删除历史仪器证据 | 🟡 开发/回归/内审完成，准备外审；P2-40 前置 |
