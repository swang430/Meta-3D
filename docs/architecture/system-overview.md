...
> ⚠️ **ARCH-1 S5（2026-07-30）读前须知**：本文 §4.1「测试计划管理」及路线图里
> 相关的 0% 条目**已作废** —— 计划链非但没做，而且在 ARCH-1 S4 里被整体拆除了
> （#244 / #246 / #247）。今天正式测试以 **TestCase** 为单一真值源，
> 执行落 `TestExecution`，没有计划、队列、步骤编排。
> 其余章节（硬件层、信道、校准）不受影响。
